...
p1
strainTest <- dataFinal[dataFinal$strain == "LZ22332",]
tempDf <- strainTest[strainTest$time == 180,]
p1 <- ggplot(data = tempDf[tempDf$avgInt > 15322.24,], mapping = aes(x= avgInt-15322.24, fill = cond)) + geom_histogram(binwidth = 700) + facet_wrap(~cond)
